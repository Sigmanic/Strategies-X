...
if CheckPlace() then
    ...
    task.spawn(function()
        ...
        --End Of Match
        local MatchGui = repeat task.wait() until LocalPlayer.PlayerGui.ReactGame.Rewards.content.gameOver or LocalPlayer.PlayerGui.RoactGame.Rewards.content.gameOver
